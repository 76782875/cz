...
$lang->user->menu->annexes  =array('link'=>'优惠项目|annex|annex|','alias'=>'managepriv,managemember');
$lang->user->menu->group  = array('link' => '分组权限|group|browse|', 'alias' => 'managepriv,managemember');
$lang->user->menu->log    = '登录日志|user|adminlog|';

/*Menu of annex module*/
$lang->annex = new stdclass();
$lang->annex->menu=new stdClass();
$lang->annex->menu->annex = '优惠内容|annex|annex|';
$lang->annex->menu->annexgroup='优惠级别|annex|annexgroup|';
$lang->annex->menu->userannex='优惠分配|annex|userannex|';
