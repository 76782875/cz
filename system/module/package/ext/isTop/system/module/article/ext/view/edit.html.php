<?php
/**
 * The extend edit view file of article module of chanzhiEPS.
 *
  ...
  <form method='post' id='ajaxForm'>
    <table class='table table-form'>
      ...
      <tr>
		...
		<?php if($type=='article'):?>
			<tr>
				<th><?php echo $lang->article->isTop;?></th>
				<td>
					<?php if ($article->isTop==true):?>
						<input type='checkbox' name='isTop' id='isTop' checked value=1 />
					<?php else: ?>
