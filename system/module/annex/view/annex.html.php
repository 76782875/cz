...
<div class='panel'>
  <div class='panel-heading'>
    <strong><i class='icon-plus'></i> <?php echo $lang->group->annex;?></strong>
    <span class='panel-actions pull-right'><?php commonModel::printLink('annex', 'create', '', $lang->group->annexcreate, "class='btn btn-primary' data-toggle='modal'");?></span>
  </div>
  <table class='table table-hover table-striped'>
    <thead>
      <tr>
       <th class='w-20px text-center'><?php echo $lang->group->id;?></th>
       <th class='w-150px text-center'><?php echo $lang->group->name;?></th>
       <th class='w-220px text-center'><?php echo $lang->group->desc;?></th>
