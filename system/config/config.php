...
/* The basic settings. */
$config = new config();
$config->version     = '4.2.1';        // The version number, don't change.
...
define('TABLE_ANNEX',        $config->db->prefix .'annex');
define('TABLE_USERANNEX',       $config->db->prefix .'userannex');
define('TABLE_ANNEXGROUP',        $config->db->prefix .'annexgroup');
